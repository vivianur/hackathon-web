...
import type { Task, TaskStatus } from "@mindease/shared";
...
export default function Tarefas() {
	...
	const getColumnColor = (originalColor: string) => {
		...
		if (originalColor === "#ed6c02")
			return mode === "light" ? "#666666" : "#888888"; // todo
		if (originalColor === "#0288d1")
			return mode === "light" ? "#555555" : "#999999"; // in-progress
		if (originalColor === "#2e7d32")
			return mode === "light" ? "#444444" : "#aaaaaa"; // done
